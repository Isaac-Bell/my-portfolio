...
const sectionVariants = {
  ...
  visible: { opacity: 1, y: 0, transition: {  duration: 1.5, ease: "easeInOut", delay: 0.9} },
};
...
export default function Home() {
  return (
   ...
   <div className="h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth scroll-container">
        ...
        <motion.section className="h-screen snap-start  section-transition"
        ...
        <motion.section className="h-screen snap-start section-transition bg-gray-800"
          variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <Projects />
        </motion.section>
