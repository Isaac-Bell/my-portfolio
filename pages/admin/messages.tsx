        ...
        <div className="space-y-4">
          <div className="flex items-center text-gray-300 bg-gray-700/30 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">"Hi, I need help with my account!"</p>
          ...
          <div className="flex items-center text-gray-300 bg-gray-700/30 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">"Can I get access to the admin panel?"</p>
          ...
          <div className="flex items-center text-gray-300 bg-gray-700/30 p-4 rounded-lg">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">"Thanks for approving my request!"</p>
