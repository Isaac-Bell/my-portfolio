...
const projects = [
  {
    ...
    description:
      'A full-stack pasture management solution with real-time inventory management and AI grazing plan generation.',
    screenshotText: 'Project Screenshot',
    screenshotUrl: '/AimerAppLogin.png',
    technologies: ['react', 'node-js', 'type-script', 'docker'],
    liveUrl: 'https://aimerapp.com/',
    videoUrl: '/videos/Aimer-App-demo.mp4',
    codeUrl: '#',
  },
  {
    title: 'neonTrade',
    description:
      'Analytics and management platform for social media accounts with real-time data visualization.',
    screenshotText: 'Project Screenshot',
    technologies: ['react', 'node-js', 'docker'],
    screenshotUrl: '/AimerAppLogin.png',
    videoUrl: '/videos/neonTrade_version_0.33.mp4',
    codeUrl: '#',
  },
  {
    title: 'Weather App',
